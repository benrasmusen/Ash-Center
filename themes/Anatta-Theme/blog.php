...
<section class="body blog">
  <div class="left-column">
    ...
    <article <?php post_class() ?> id="post-<?php the_ID(); ?>">
      <header>
        ...
        <h2><a href="<?php the_permalink(); ?>" title="permanent link to <?php the_permalink(); ?>">
          <?php the_title(); ?>
          </a></h2>
      </header>
      <section class="posts">
  ...
  <div class="right-column">
  	<div id="sidebar">
    <?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('blog-sidebar') ) : else : // Sidebar for Blog?>
    <?php endif; ?>
    </div>
  </div>
  <div class="clear"></div>
