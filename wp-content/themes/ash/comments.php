<!-- TODO: Need markup for comments form and list -->
<div id="comments">
	<?php if ( post_password_required() ) : ?>
		<p class="nopassword"><?php echo __( 'This post is password protected. Enter the password to view any comments.' ); ?></p>
	</div><!-- #comments -->
	<?php
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above">
			<h1 class="assistive-text"><?php echo __( 'Comment navigation' ); ?></h1>
